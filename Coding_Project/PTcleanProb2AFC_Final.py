...
## ENDING SCREEN ##
df = pd.read_csv(SubjectDataFile) #turn the csv into a datafile
total_points = df["points"].sum() #get the sum of the reward column in the df
#end text that includes thank you message and point total
end_text = thankMsg + "\n\nYour point total is:\n\n" + str(total_points)
show_instructions(end_text) #show thank you message and point total at end of experiment
