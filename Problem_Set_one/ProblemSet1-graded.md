...
>> **Should just use `mv *.txt` or `mv subj*.txt`**
...
>> **Should use something like `rm subj0?.txt'**
...
>> **Great! but you didn't include the file you created!**
...
>> **correct, but I'm not sure what you mean by 'personal files'.
...
>> **Your pictures aren't displaying properly. You need to put `!` in front of it. When I do that though the pictures still don't work, but I'm not sure why. Maybe the underscores in the file names? In any case test your code!*
